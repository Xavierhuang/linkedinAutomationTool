...
const PostsView = ({ orgId }) => {
  ...
  return (
    <div className="h-full flex flex-col" style={{ backgroundColor: '#FAFAFA' }}>
      {/* Header */}
      <div style={{ padding: '24px 24px 16px 24px', backgroundColor: '#FAFAFA' }}>
        <div className="flex items-center justify-between mb-4">
          <h1 style={{ fontSize: '24px', fontWeight: 700, color: '#1A1A1A', margin: 0 }}>Posts</h1>
          ...
          <div style={{ display: 'flex', gap: '4px' }}>
            ...
            <button
              ...
              style={{
                ...
                border: viewMode === 'grid' ? '1px solid #2563EB' : '1px solid #E5E7EB',
                borderRadius: '4px',
                cursor: 'pointer'
              }}
              className="hover:bg-gray-100 transition"
...
const ListView = ({ posts, selectionMode, selectedPosts, onToggleSelect, onEnterSelectionMode }) => {
  return (
    <div style={{ backgroundColor: '#FFFFFF', borderRadius: '8px', overflow: 'visible' }}>
      {/* Table Header */}
      <div style={{
        display: 'grid',
